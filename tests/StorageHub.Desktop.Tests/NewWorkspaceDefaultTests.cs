...
public sealed class NewWorkspaceDefaultTests
{
    ...
    public void APaneCountRoundTripsAndAskEveryTimeIsTheDefault()
    {
        ...
        Assert.Equal(3, new DesktopConfigStore(fixture.Root).Load().DefaultWorkspacePaneCount);
    ...
    private static StorageHubChoiceField Combo(SettingsForm settings) =>
        (StorageHubChoiceField)typeof(SettingsForm)
    ...
    private sealed class SettingsFixture : IDisposable
    {
        internal SettingsFixture()
        {
            ...
            Store = new DesktopConfigStore(Root);
        }
