...
public sealed class SettingsTransferFormTests
{
    ...
    public void ExportIsRefusedUntilTheTwoPasswordsAgree()
    {
        WithExportForm((form, _) =>
        {
            ...
            var password = Field<StorageHubTextField>(form, "_password");
            var confirm = Field<StorageHubTextField>(form, "_confirm");
    ...
    public void AWrongPasswordKeepsTheWizardOnTheFileStep()
    {
        WithImportForm((form, fixture) =>
        {
            ...
            form.LoadFile(path);
            Field<StorageHubTextField>(form, "_password").Text = "not the password";
            Open(form);
            ...
            Field<StorageHubTextField>(form, "_password").Text = Password;
            Open(form);
    ...
    public void ImportingAppliesOnlyTheTickedSections()
    {
        WithImportForm((form, fixture) =>
        {
            ...
            var source = new DesktopConfigStore(Path.Combine(fixture.Directory, "source"));
