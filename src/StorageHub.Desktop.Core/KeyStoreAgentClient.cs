...
public sealed class NamedPipeKeyStoreAgentClient : IKeyStoreAgentClient
{
        ...
        where TResponse : class
    {
        ...
        {
            throw new TimeoutException(Ui.Validation.TheLocalAgentKeyStoreRequestTimed, error);
        }
        ...
        try
        {
            ...
            {
                throw new InvalidDataException(Ui.Validation.TheLocalAgentReturnedInvalidKeyStore, error);
            }
        ...
        catch (OperationCanceledException error) when (!cancellationToken.IsCancellationRequested)
        {
            ...
            throw new TimeoutException(Ui.Validation.TheLocalAgentKeyStoreRequestTimed2, error);
        }
        ...
        string expectedMessageType)
    {
        ...
        {
            throw new InvalidDataException(Ui.Validation.TheLocalAgentRejectedTheKeyStore);
        }
    ...
    private static void Validate(object? request, bool withinBounds)
    {
        ...
        if (!withinBounds)
        {
            throw new ArgumentException(
                Ui.Validation.TheKeyStoreRequestIsOutsideThe,
                nameof(request));
        }
    }

    private static InvalidDataException InvalidResponse() =>
        new(Ui.Validation.TheLocalAgentReturnedKeyStoreData);
    ...
    private static void ValidateOptions(KeyStoreAgentClientOptions options)
    {
        ...
        if (options.RequestTimeout <= TimeSpan.Zero || options.RequestTimeout > TimeSpan.FromMinutes(2))
        {
            throw new ArgumentOutOfRangeException(
                nameof(options),
                Ui.Validation.TheRequestTimeoutMustBeAtMost2);
        }
    }
