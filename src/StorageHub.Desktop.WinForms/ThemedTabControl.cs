...
public class ThemedTabControl : TabControl
{
    ...
    /// <summary>
    /// Set when the owner draws the headers itself and the shared renderer must keep out.
    /// </summary>
    /// <remarks>
    /// A property rather than something inferred from the control. This was previously decided by
    /// comparing <see cref="Control.AccessibleName"/> to the literal "Workspace tabs", which held
    /// only while that name was English: once it was translated the shared renderer was attached
    /// alongside the owner's, and because the theme walk re-subscribes it after construction it
    /// painted last and covered the workspace icon and close cross. A control's identity cannot
    /// live in text that is meant to change.
    /// </remarks>
    [System.ComponentModel.DesignerSerializationVisibility(
        System.ComponentModel.DesignerSerializationVisibility.Hidden)]
    public bool OwnsItemRendering { get; set; }
