...
internal static class SettingsSectionCatalog
{
    ...
    [
        new(
            ...
            "desktopGeneral",
            Ui.SettingsTransfer.DesktopPreferences,
            Ui.SettingsTransfer.AppearanceTransferAndSyncConcurrencyEditingLimits,
        ...
        new(
            ...
            "shortcuts",
            Ui.SettingsTransfer.KeyboardShortcuts,
            Ui.SettingsTransfer.EveryRebindableCommandShortcut,
            CheckedByDefault: true,
            RequiresAgent: false,
            []),
        new(
            ...
            "connectionDefaults",
            Ui.SettingsTransfer.ConnectionDefaults,
            Ui.SettingsTransfer.ThePerProviderTimeoutsPortsAndOptions,
            CheckedByDefault: true,
            RequiresAgent: false,
            []),
        new(
            ...
            "machineSpecific",
            Ui.SettingsTransfer.ThisComputerOnly,
            Ui.SettingsTransfer.EditorPathPinnedAndRecentWorkspacesAnd +
        ...
        new(
            ...
            "connections",
            Ui.SettingsTransfer.ConnectionProfiles,
            Ui.SettingsTransfer.SavedConnectionsWithoutTheirCredentialsWhichNever,
            CheckedByDefault: true,
            RequiresAgent: true,
            []),
        new(
            ...
            "syncProfiles",
            Ui.SettingsTransfer.SyncTasks,
            Ui.SettingsTransfer.SyncTaskDefinitionsIncludingTheirFiltersAnd,
            CheckedByDefault: true,
            RequiresAgent: true,
            [SettingsSectionId.Connections]),
        new(
            ...
            "schedules",
            Ui.SettingsTransfer.Schedules,
            Ui.SettingsTransfer.WhenEachSyncTaskRuns,
            CheckedByDefault: true,
            RequiresAgent: true,
            [SettingsSectionId.SyncProfiles])
    ];
    ...
    internal static SettingsSectionDefinition Get(SettingsSectionId id) =>
        ...
        throw new ArgumentOutOfRangeException(nameof(id), id, Ui.SettingsTransfer.UnknownSettingsSection);
