...
public sealed class NamedPipeRemoteStorageAgentClient : IRemoteStorageAgentClient
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            throw new ArgumentException(Ui.Validation.TheConnectionListRequestIsOutsideThe, nameof(request));
        }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (!StorageIpcContract.IsSupported(request.ContractVersion) || !request.HasValidBounds)
        {
            throw new ArgumentException(Ui.Validation.TheConnectionTestRequestIsOutsideThe, nameof(request));
        }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (!StorageIpcContract.IsSupported(request.ContractVersion) || !request.HasValidBounds)
        {
            throw new ArgumentException(Ui.Validation.TheStorageListRequestIsOutsideThe, nameof(request));
        }
        ...
        where TResponse : class
    {
        ...
        try
        {
            ...
            {
                throw new InvalidDataException(Ui.Validation.TheLocalAgentReturnedAnInvalidResponse, error);
            }
        ...
        string expectedMessageType)
    {
        ...
        {
            throw new InvalidDataException(Ui.Validation.TheLocalAgentResponseDidNotMatch);
        }

        if (string.Equals(envelope.MessageType, IpcProtocol.ErrorResponseMessageType, StringComparison.Ordinal))
        {
            throw new InvalidDataException(Ui.Validation.TheLocalAgentRejectedTheStorageRequest);
        }

        if (!string.Equals(envelope.MessageType, expectedMessageType, StringComparison.Ordinal))
        {
            throw new InvalidDataException(Ui.Validation.TheLocalAgentReturnedAnUnexpectedResponse);
        }
    }
    ...
    private static InvalidDataException InvalidResponse() =>
        new(Ui.Validation.TheLocalAgentReturnedAStorageResponse);
