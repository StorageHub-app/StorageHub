...
public interface ITransferQueueAgentClient : IAsyncDisposable
{
    ...
    Task<TransferHistoryClearResponse> ClearHistoryAsync(
        ...
        CancellationToken cancellationToken = default) =>
        throw new NotSupportedException(Ui.Validation.ThisTransferClientDoesNotSupportClearing);

    Task<ShellImportPlanResponse> PlanShellImportAsync(
        ShellImportPlanRequest request,
        CancellationToken cancellationToken = default) => throw new NotSupportedException(Ui.Validation.ThisTransferClientDoesNotSupportShell2);
    ...
    Task<ShellExportPrepareResponse> PrepareShellExportAsync(
        ...
        CancellationToken cancellationToken = default) => throw new NotSupportedException(Ui.Validation.ThisTransferClientDoesNotSupportShell);

    Task<ExplorerDropBeginResponse> BeginExplorerDropAsync(
        ExplorerDropBeginRequest request,
        CancellationToken cancellationToken = default) => throw new NotSupportedException(Ui.Validation.ThisTransferClientDoesNotSupportExplorer);
...
public sealed class NamedPipeTransferQueueAgentClient : ITransferQueueAgentClient
{
    ...
    public Task<ShellImportPlanResponse> PlanShellImportAsync(ShellImportPlanRequest request, CancellationToken cancellationToken = default)
    {
        ...
        if (!ShellTransferIpcContract.IsSupported(request.ContractVersion) || !request.HasValidBounds)
            throw new ArgumentException(Ui.Validation.TheShellImportPlanIsOutsideThe, nameof(request));
    ...
    public Task<ShellImportCommitResponse> CommitShellImportAsync(ShellImportCommitRequest request, CancellationToken cancellationToken = default)
    {
        ArgumentNullException.ThrowIfNull(request);
        if (!ShellTransferIpcContract.IsSupported(request.ContractVersion) || !request.HasValidBounds)
            throw new ArgumentException(Ui.Validation.TheShellImportCommitIsOutsideThe, nameof(request));
    ...
    public Task<ShellExportPrepareResponse> PrepareShellExportAsync(ShellExportPrepareRequest request, CancellationToken cancellationToken = default)
    {
        ArgumentNullException.ThrowIfNull(request);
        if (!ShellTransferIpcContract.IsSupported(request.ContractVersion) || !request.HasValidBounds)
            throw new ArgumentException(Ui.Validation.TheShellExportRequestIsOutsideThe, nameof(request));
        ...
        CancellationToken cancellationToken = default)
    {
        ArgumentNullException.ThrowIfNull(request);
        if (!ShellTransferIpcContract.IsSupported(request.ContractVersion) || !request.HasValidBounds)
            throw new ArgumentException(Ui.Validation.TheExplorerDropRequestIsOutsideThe, nameof(request));
        ...
        CancellationToken cancellationToken = default)
    {
        ArgumentNullException.ThrowIfNull(request);
        if (!ShellTransferIpcContract.IsSupported(request.ContractVersion) || !request.HasValidBounds)
            throw new ArgumentException(Ui.Validation.TheExplorerDropCommitIsOutsideThe, nameof(request));
            ...
            if (status.State == ShellExportState.Failed || status.Failure is not null)
            {
                return new ShellExportPrepareResponse(status.ContractVersion, [], status.Failure ??
                    new StorageIpcFailure("shell-transfer.failed", StorageIpcFailureCategory.Unavailable,
                        Ui.Validation.StorageHubCouldNotPrepareTheSelectedItems, true));
            }
        ...
        where TResponse : class
    {
        ...
        {
            throw new TimeoutException(Ui.Validation.TheLocalAgentRequestTimedOutBefore, error);
        }
        ...
        try
        {
            ...
            {
                throw new InvalidDataException(Ui.Validation.TheLocalAgentReturnedAnInvalidTransfer, error);
            }
        ...
        catch (OperationCanceledException error) when (!cancellationToken.IsCancellationRequested)
        {
            ...
            throw new TimeoutException(Ui.Validation.TheLocalAgentRequestTimedOut, error);
        }
        ...
        catch (UnauthorizedAccessException)
        {
            ...
            throw new UnauthorizedAccessException(
                Ui.Validation.StorageHubCouldNotAuthenticateToTheLocal);
        }
        ...
        string expectedMessageType)
    {
        ...
        {
            throw new InvalidDataException(Ui.Validation.TheLocalAgentRejectedTheTransferRequest);
        }
    ...
    private static void ValidateRequest(int version, bool hasValidBounds, string parameterName)
    {
        if (!TransferQueueIpcContract.IsSupported(version) || !hasValidBounds)
        {
            throw new ArgumentException(
                Ui.Validation.TheTransferRequestIsOutsideTheNegotiated,
                parameterName);
        }
    }
    ...
    private static InvalidDataException InvalidResponse() =>
        new(Ui.Validation.TheLocalAgentReturnedATransferResponse);
    ...
    private static void ValidateOptions(RemoteStorageAgentClientOptions options)
    {
        ...
        {
            throw new ArgumentOutOfRangeException(nameof(options), Ui.Validation.TheConnectTimeoutMustBeAtMost);
        }
    ...
    private sealed class NamedPipeTransferIpcTransport(IpcClient client) : IStorageIpcTransport
    {
