...
public sealed class NamedPipeScheduleManagementAgentClient : IScheduleManagementAgentClient
{
        ...
        where TResponse : class
    {
        ...
        try
        {
            ...
            {
                throw new InvalidDataException(Ui.Validation.TheLocalAgentReturnedInvalidScheduleData, error);
            }
        ...
        catch (OperationCanceledException error) when (!cancellationToken.IsCancellationRequested)
        {
            ...
            throw new TimeoutException(Ui.Validation.TheLocalAgentScheduleRequestTimedOut, error);
        }
    ...
    private static void ValidateEnvelope(IpcEnvelope envelope, Guid requestId, string responseType)
    {
        ...
        {
            throw new InvalidDataException(Ui.Validation.TheLocalAgentRejectedTheScheduleRequest);
        }
        ...
        where TRequest : class
    {
        ...
        if (!ScheduleManagementIpcContract.IsSupported(version) || !validBounds)
        {
            throw new ArgumentException(
                Ui.Validation.TheScheduleRequestIsOutsideTheNegotiated,
                parameterName);
        }
    }
    ...
    private static InvalidDataException InvalidResponse() =>
        new(Ui.Validation.TheLocalAgentReturnedScheduleDataOutside);
