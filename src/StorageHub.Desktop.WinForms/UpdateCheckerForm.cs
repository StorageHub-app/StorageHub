...
internal sealed class UpdateCheckerForm : Form
{
    ...
    private readonly StorageHubButton _primary;
    ...
    public UpdateCheckerForm(DesktopUpdater updater)
    {
        ...
        Text = Ui.Updates.StorageHubUpdates;
        ...
        _progress = new ProgressBar
        {
            ...
            Maximum = 100,
            Visible = false,
            AccessibleName = Ui.Updates.UpdateDownloadProgress
        };
    ...
    {
        _installed.Text = Ui.Updates.InstalledVersion + DesktopApplicationVersion.Current;
