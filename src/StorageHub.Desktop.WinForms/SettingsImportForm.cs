...
public sealed class SettingsImportForm : Form
{
    ...
    private readonly StorageHubButton _back;
    private readonly StorageHubButton _import;
    private readonly StorageHubButton _close;
    ...
    internal SettingsImportForm(SettingsImportService importer)
    {
        ...
        Text = Ui.SettingsTransfer.ImportSettings;
        AccessibleName = Ui.SettingsTransfer.ImportSettings2;
        AccessibleDescription = Ui.SettingsTransfer.ReviewASettingsFileAndChooseWhat;
        ...
        _open.Variant = StorageHubButtonVariant.Primary;
        ...
        _conflictPolicy.DisplayText = static item => item switch
        {
            SettingsConflictPolicy.Replace => Ui.SettingsTransfer.ReplaceWhatIsAlreadyHere,
            SettingsConflictPolicy.ImportAsCopy => Ui.SettingsTransfer.KeepBothImportingAsACopy,
            _ => Ui.SettingsTransfer.LeaveWhatIsAlreadyHereAlone
        };
        ...
        {
            Text = Ui.SettingsTransfer.ConnectionsAndTasksThatAlreadyExistHere,
            AutoSize = true,
            Visible = false,
            ForeColor = StorageHubTheme.Text
        };
    ...
    internal void LoadFile(string path)
    {
        ...
        {
            ShowFileProblem(name, inspection.Message ?? Ui.SettingsTransfer.ThatFileCouldNotBeRead);
            return;
        }
        ...
        _passwordPrompt.Text = needsPassword ? Ui.SettingsTransfer.EnterTheFileSPassword : string.Empty;
    ...
    private void OpenSelectedFile()
    {
        ...
        if (result.Document is null)
        {
            ...
            _passwordPrompt.Text = result.Message ?? Ui.SettingsTransfer.ThatFileCouldNotBeOpened;
    ...
    private static string DescribeContents(SettingsExportDocument document, SettingsSectionDefinition section)
    {
        ...
        {
            SettingsSectionId.DesktopGeneral => Ui.SettingsTransfer.ReplacesAppearanceConcurrencyEditingAndUpdatePreferences,
            SettingsSectionId.MachineSpecific => Ui.SettingsTransfer.ReplacesTheEditorPathAndThePinned,
    ...
    private void BuildResult(SettingsImportReport report)
    {
        ...
        _backupLink.Text = report.BackupPath is null
            ? string.Empty
            : Ui.SettingsTransfer.ShowTheBackupOfYourPreviousSettings;
        ...
        _close.Text = Ui.Dialogs.ButtonClose;
    ...
    private void ShowBackup()
    {
        ...
        {
            _ = MessageBox.Show(
                this, path, Ui.Dialogs.BackupLocationCaption, MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
    }
